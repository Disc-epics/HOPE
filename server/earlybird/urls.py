...
from earlybird.views import acct_page, register_page, confirm_user, client_page, get_status, logout_view, settings_page, master_page, \
    master_snoop, change_password, master_remove, scrape_page, remove_client, forgot_password
